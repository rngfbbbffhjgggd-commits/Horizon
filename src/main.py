...
def main():
    ...
    parser.add_argument("--since", type=str, help="Fetch from this ISO datetime (overrides --hours)")
    ...
    try:
        ...
        asyncio.run(orchestrator.run(force_hours=args.hours, since_str=args.since))
